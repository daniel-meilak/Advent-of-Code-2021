...
int main(){
    ...
    for (int i=0; i<days; i++){
        ...
        if (i == 79){ part_1 = std::accumulate(stages.begin(),stages.end(),0ll); }
    }

    // count all fish 
    part_2 = std::accumulate(stages.begin(),stages.end(),0ll);
